...
@section('title', 'Editar tarea recurrente — GestioDia')
...
<div class="container py-5" style="max-width: 30rem;">
    ...
    <h1 class="mb-4">Editar tarea recurrente</h1>
    ...
    <form method="POST" action="{{ route('tasks.recurring.update', $recurringTask) }}">
        @csrf
        @method('PUT')
        @include('tasks.recurring._form', ['recurringTask' => $recurringTask])
